...
class AdminMissingReportsScreen extends StatelessWidget {
  const AdminMissingReportsScreen({super.key});
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (docs.isEmpty) {
            return const Center(child: Text('No missing item reports found.'));
          }
